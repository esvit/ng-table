namespace Tests {
    ...
    describe('ng-table', () => {
        ...
        interface INgTableChildScope extends ng.IScope {
            params: ngtc.INgTableParams<any>;
            $columns: NgTable.Browser.IColumnDef[];
        }

        interface ICustomizedScope extends ng.IScope {
            $$childHead: INgTableChildScope;
            ageFilter: NgTable.Browser.IFilterTemplateDefMap;
            ageExpandedFilter: { [name: string]: NgTable.Browser.IFilterTemplateDef };
            ageTitle: string | { (): string };
            captureColumn: ($columnDef: NgTable.Browser.IColumnDef) => any;
            getCustomClass($column: NgTable.Browser.IColumnDef): string;
            getFilter($column: NgTable.Browser.IColumnDef): NgTable.Browser.IFilterTemplateDefMap;
            isAgeVisible: boolean;
            nameTitle(): string;
            money: () => ng.IPromise<NgTable.Browser.ISelectOption[]>;
            moneyTitle(): string;
            showAge: boolean;
            showFilterRow: boolean;
            showMoney: boolean;
            showName: boolean;
            tableParams: ngtc.INgTableParams<IPerson>;
            usernameFilter: NgTable.Browser.IFilterTemplateDefMap;
            usernameExpandedFilter: { [name: string]: NgTable.Browser.IFilterTemplateDef };
        }
        ...
        var NgTableParams: ngtc.ITableParamsConstructor<any>;

        beforeEach(angular.mock.module('ngTable'));

        var scope: ICustomizedScope;
        beforeEach(inject(($rootScope: ng.IScope, _NgTableParams_: ngtc.ITableParamsConstructor<any>) => {
        ...
        describe('sorting', () => {
            ...
            it('should provide $column definition', inject(function ($compile: ng.ICompileService) {
                var columnDef: NgTable.Browser.IColumnDef;
            ...
            it('should apply initial sort', inject(function ($compile: ng.ICompileService) {
                ...
                var actualSort: ngtc.ISortingValues;
        ...
        describe('filters', () => {
            ...
            var $capturedColumn: NgTable.Browser.IColumnDef;
            beforeEach(inject(() => {
            ...
            describe('filter specified as alias', () => {
                ...
                var elm: ng.IAugmentedJQuery,
                    tp: ngtc.INgTableParams<IPerson>;
                beforeEach(inject(function ($compile: ng.ICompileService) {
                    elm = angular.element(
                        '<div>' +
                        '<table ng-table="tableParams">' +
        ...
        describe('$columns', () => {
            ...
            it('each column attribute should be assignable', () => {
                ...
                var newFilter: NgTable.Browser.IFilterTemplateDefMap = { age: 'select' };
