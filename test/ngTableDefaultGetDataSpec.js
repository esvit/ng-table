describe('ngTableDefaultGetData', function () {
    describe('provider', function () {
        ...
        beforeEach(function () {
            angular.mock.module(function (_ngTableDefaultGetDataProvider_) {
        ...
        describe('filters', function () {
            ...
            describe('filterComparator', function () {
                it('function', function () {
                    // given
                    var comparer = function (actual, expected) { return angular.equals(actual, expected); };
    ...
    describe('service, custom filters', function () {
        ...
        beforeEach(function () {
            ...
            angular.mock.module('ngTable', function ($provide) {
            ...
            function myCustomFilter() {
                ...
                function filter(people, criteriaObj /*, comparator*/) {
                    return people.filter(function (p) { return criteriaObj.ages.indexOf(p.age) !== -1; });
                }
            }
        });
        beforeEach(inject(function (_ngTableDefaultGetData_, NgTableParams) {
        ...
        it('custom filter function', function () {
            ...
            var filterFn = function (data, criteriaObj /*, comparator*/) {
                return data.filter(function (p) { return criteriaObj.ages.indexOf(p.age) !== -1; });
            };
