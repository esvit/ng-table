namespace Tests {
    ...
    describe('ngTableDefaultGetData', () => {
        ...
        describe('provider', () => {
            ...
            let ngTableDefaultGetDataProvider: ngtc.IDefaultGetDataProvider;

            beforeEach(angular.mock.module("ngTable"));
            beforeEach(() => {
                angular.mock.module((_ngTableDefaultGetDataProvider_: ngtc.IDefaultGetDataProvider) => {
        ...
        describe('service', () => {
            let ngTableDefaultGetData: ngtc.IDefaultGetData<any>,
                tableParams: ngtc.INgTableParams<any>;

            beforeEach(angular.mock.module('ngTable'));

            beforeEach(inject((
                _ngTableDefaultGetData_: ngtc.IDefaultGetData<any>,
        ...
        describe('service, custom filters', () => {
            var ngTableDefaultGetData: ngtc.IDefaultGetData<IPerson>,
            ...
            beforeEach(inject((
                _ngTableDefaultGetData_: ngtc.IDefaultGetData<IPerson>,
                NgTableParams: ngtc.ITableParamsConstructor<IPerson>) => {
                ngTableDefaultGetData = _ngTableDefaultGetData_;
                tableParams = new NgTableParams({ count: 10 }, { counts: [10] });
            }));
