namespace Tests {
    describe('ngTableFilterConfig', () => {
        let ngTableFilterConfig: NgTable.Browser.IFilterConfig,
            ngTableFilterConfigProvider: NgTable.Browser.IFilterConfigProvider;

        beforeEach(angular.mock.module("ngTable"));
        beforeEach(() => {
            angular.mock.module((_ngTableFilterConfigProvider_: NgTable.Browser.IFilterConfigProvider) => {
        ...
        beforeEach(inject((_ngTableFilterConfig_: NgTable.Browser.IFilterConfig) => {
