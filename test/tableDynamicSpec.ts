namespace Tests {
    ...
    describe('ng-table-dynamic', () => {
        ...
        interface IExtendedDynamicTableColDef extends NgTable.Browser.IDynamicTableColDef {
            field: NgTable.Browser.DynamicTableColField<string>
        }
        ...
        describe('basics', () => {
            ...
            beforeEach(inject(function ($compile: ng.ICompileService, $q: ng.IQService, NgTableParams: ngtc.ITableParamsConstructor<any>) {
                elm = angular.element(
                    '<div>' +
                ...
                function getCustomClass(context: NgTable.Browser.ColumnFieldContext) {
                ...
                function money(context: NgTable.Browser.ColumnFieldContext) {
                    let selectOptions = [{
                        'id': 10,
                        'title': '10'
                    }];
            ...
            it('should show data-title-text', inject(function (NgTableParams: ngtc.ITableParamsConstructor<IPerson>) {
            ...
            it('should show/hide columns', inject(function (NgTableParams: ngtc.ITableParamsConstructor<IPerson>) {
                var tbody = elm.find('tbody');
        ...
        describe('changing column list', () => {
            var elm: ng.IAugmentedJQuery;
            beforeEach(inject(function ($compile: ng.ICompileService, $q: ng.IQService, NgTableParams: ngtc.ITableParamsConstructor<IPerson>) {
                elm = angular.element(
                    '<div>' +
                    '<table ng-table-dynamic="tableParams with cols">' +
                    '<tr ng-repeat="user in $data">' +
                ...
                function getCustomClass(parmasScope: NgTable.Browser.ColumnFieldContext) {
        ...
        describe('title-alt', () => {
            ...
            var elm: ng.IAugmentedJQuery;
            beforeEach(inject(function ($compile: ng.ICompileService, NgTableParams: ngtc.ITableParamsConstructor<IPerson>) {
                elm = angular.element(
                    '<table ng-table-dynamic="tableParams with cols">' +
                    '<tr ng-repeat="user in $data">' +
                    '<td ng-repeat="col in $columns">{{user[col.field]}}</td>' +
        ...
        describe('filters', () => {
            ...
            describe('select filter', () => {
                ...
                it('should render select list return as a promise', () => {
                    ...
                    var $column = (select.scope() as NgTable.Browser.ColumnFieldContext).$column;
                    var plucker = _.partialRight(_.pick, ['id', 'title']);
                    var actual = _.map($column.data as NgTable.Browser.ISelectOption[], plucker);
            ...
            describe('dynamic filter', () => {
                ...
                var ageFilter: NgTable.Browser.IFilterTemplateDefMap;
                beforeEach(inject(function ($compile: ng.ICompileService, NgTableParams: ngtc.ITableParamsConstructor<IPerson>) {

                    ageFilter = { age: 'text' };
                    function getFilter(paramsScope: NgTable.Browser.ColumnFieldContext): NgTable.Browser.IFilterTemplateDefMap {
