namespace Tests {
    ...
    describe('NgTableParams', () => {
        ...
        var scope: ng.IScope,
            NgTableParams: ngtc.ITableParamsConstructor<any>,
        ...
        beforeEach(() => {
            angular.mock.module(($provide: ng.auto.IProvideService) => {
                ...
                function createSpy(ngTableDefaultGetData: ngtc.IDefaultGetData<any>) {
                    return jasmine.createSpy('ngTableDefaultGetDataSpy', ngTableDefaultGetData).and.callThrough();
                }
            });
        });

        beforeEach(inject(($controller: ng.IControllerService, _$rootScope_: IScopeWithPrivates, _NgTableParams_: ngtc.ITableParamsConstructor<any>) => {
            $rootScope = _$rootScope_;
            scope = $rootScope.$new();
            NgTableParams = _NgTableParams_;
        }));

        function createNgTableParams<T>(initialParams?: ngtc.IParamValues<T>, settings?: ngtc.ISettings<T>): ngtc.INgTableParams<T>;
        function createNgTableParams<T>(settings?: ngtc.ISettings<T>): ngtc.INgTableParams<T>;
        function createNgTableParams<T>(settings?: any): ngtc.INgTableParams<T> {
            var initialParams: ngtc.IParamValues<T>;
        ...
        describe('group', () => {
            ...
            it('multiple groups', () => {
                ...
                var newGroups = _.extend<{}, ngtc.IGroupValues>({}, params.group(), { age: 'desc' });
        ...
        describe('settings', () => {
            ...
            it('defaults', () => {
                ...
                var expectedSettings: ngtc.ISettings<any> = {
                    $loading: false,
                    dataset: null,
                    total: 0,
                    defaultSort: 'desc',
        ...
        describe('getGroups', () => {
            ...
            it('should group data then apply paging to groups', () => {
                ...
                var actualRoleGroups: ngtc.IDataRowGroup<IEmployee>[];
                tp.reload<ngtc.IDataRowGroup<IEmployee>>().then(groups => {
                    actualRoleGroups = groups;
                });
                $rootScope.$digest();

                var expectedRoleGroups: ngtc.IDataRowGroup<IEmployee>[] = [
                    {
                        $hideRows: false,
                        value: 'Accounting',
                        data: [
            ...
            it('should use group function to group data', () => {
                var grouper: ngtc.IGroupingFunc<IEmployee> = (item) => item.name[0];
            ...
            it('should use sortDirection defined on group function to sort groups', () => {
                var groupFn: ngtc.IGroupingFunc<IEmployee> = item => item.role;
        ...
        describe('getGroups with nested property', () => {
            ...
            it('should group data then apply paging to groups', () => {
                ...
                var actualRoleGroups: ngtc.IDataRowGroup<IComplexEmployee>[];
                tp.reload<ngtc.IDataRowGroup<IComplexEmployee>>().then(groups => {
                    actualRoleGroups = groups;
                });
                $rootScope.$digest();

                let expectedRoleGroups: ngtc.IDataRowGroup<IComplexEmployee>[] = [
                    {
                        $hideRows: false,
                        value: 'Accounting',
                        data: [
            ...
            it('should use group function to group data', () => {
                var grouper: ngtc.IGroupingFunc<IComplexEmployee> = item => item.details.name[0];
                grouper.sortDirection = '';
                var tp = createNgTableParams({
                    count: 2,
                    sorting: { 'details.name': 'desc' },
            ...
            it('should use sortDirection defined on group function to sort groups', () => {
                var groupFn: ngtc.IGroupingFunc<IComplexEmployee> = item => item.details.role;
                groupFn.sortDirection = 'desc';
                var tp = createNgTableParams({
                    count: 3,
                    sorting: { 'details.name': 'desc' },
        ...
        it('ngTableParams test defaults', inject(($q: ng.IQService, ngTableDefaults: ngtc.IDefaults) => {
        ...
        describe('hasFilter', () => {
            var tp: ngtc.INgTableParams<any>;
        ...
        describe('isDataReloadRequired', () => {
            ...
            it('should return true when group function sort direction changes', () => {
                ...
                var grouper: ngtc.IGroupingFunc<any> = () => '';
                tp.group(grouper);
                expect(tp.isDataReloadRequired()).toBe(true);
        ...
        describe('interceptors', () => {
            ...
            describe('one response interceptor', () => {
                ...
                it('should be able to access tableParams supplied to getData', () => {
                    ...
                    // given
                    var interceptor = {
                        response: (data: QueryResult, params: ngtc.INgTableParams<number>) => {
            ...
            describe('one responseError interceptor', () => {
                ...
                it('should be able to access tableParams supplied to getData', () => {
                    // given
                    var interceptor = {
                        actualParams: null as ngtc.INgTableParams<number>,
                        response: function (data: number[], params: ngtc.INgTableParams<number>) {
        ...
        describe('events', () => {
            ...
            var actualEventArgs: any[],
                actualPublisher: ngtc.INgTableParams<any>,
                fakeTableParams: ngtc.InternalTableParams<any>,
            ...
            describe('general pub/sub mechanics', () => {
                ...
                it('publisher should be supplied to subscriber callback', () => {
                    ...
                    function test(event: string) {
                        // given
                        ngTableEventsChannel['on' + event](function (params: ngtc.INgTableParams<any>) {
                ...
                it('remaining event args should be supplied to subscriber callback', () => {
                    ...
                    function test(event: string) {
                        // given
                        ngTableEventsChannel['on' + event](function (params: ngtc.INgTableParams<any>, ...args: any[]) {
                            actualPublisher = params;
