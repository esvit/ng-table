...
var html = "<div class=\"ng-cloak ng-table-pager\" ng-if=\"params.data.length\" aria-label=\"{{params.$params.accessibilityOptions.pagerTitle}}\">\r\n    <div ng-if=\" params.settings().counts.length \" class=\"ng-table-counts btn-group pull-right \">\r\n        <button ng-repeat=\"count in params.settings().counts \" type=\"button \"\r\n                ng-class=\"{ 'active':params.count()==count} \"\r\n                ng-click=\"params.count(count) \" class=\"btn btn-default \">\r\n            <span ng-bind=\"count \"></span>\r\n        </button>\r\n    </div>\r\n    <ul ng-if=\"pages.length \" class=\"pagination ng-table-pagination \">\r\n        <li ng-class=\"{ 'disabled': !page.active && !page.current, 'active': page.current} \" ng-repeat=\"page in pages\" ng-switch=\"page.type \">\r\n            <a ng-switch-when=\"prev \" ng-click=\"params.page(page.number) \" href=\" \" aria-label=\"{{params.$params.accessibilityOptions.prev}} \">\r\n                <span aria-hidden=\"true \">&laquo;</span></a>\r\n            <a ng-switch-when=\"first \" ng-click=\"params.page(page.number) \" href=\" \"><span ng-bind=\"page.number \">\r\n                <span ng-if=\"page.current \" class=\"sr-only \">{{params.$params.accessibilityOptions.current}}</span></span></a>\r\n            <a ng-switch-when=\"page \" ng-click=\"params.page(page.number) \" href=\" \"><span ng-bind=\"page.number \">\r\n                <span ng-if=\"page.current \" class=\"sr-only \">{{params.$params.accessibilityOptions.current}}</span></span></a>\r\n            <a ng-switch-when=\"more \" ng-click=\"params.page(page.number) \" href=\" \" aria-label=\"{{params.$params.accessibilityOptions.more}} \">\r\n                <span aria-hidden=\"true \">&#8230;</span></a>\r\n            <a ng-switch-when=\"last \" ng-click=\"params.page(page.number) \" href=\" \"><span ng-bind=\"page.number \">\r\n                <span ng-if=\"page.current \" class=\"sr-only \">{{params.$params.accessibilityOptions.current}}</span></span></a>\r\n            <a ng-switch-when=\"next \" ng-click=\"params.page(page.number) \" href=\" \" aria-label=\"{{params.$params.accessibilityOptions.next}} \">\r\n                <span aria-hidden=\"true \">&raquo;</span></a>\r\n        </li>\r\n    </ul>\r\n</div>\r\n";
var angular = __webpack_require__(/*! angular */ 0);
angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
